...
status = cycle(['명일방주', '블루 아카이브', '소녀전선', 'Lobotomy Corporation', 'Library of Ruina', '벽람항로', 'Sid Meier\'s Civilization VI', 'Yu-Gi-Oh! Master Duel', '프린세스 커넥트! Re:Dive', 'Fate/Grand Order'])
